...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    LoadStringW(hInstance, IDC_MEDIA, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MEDIA));
    ...
    CutMediaFile(media_file_path_string, cut_file_path_string, start_time,end_time);
    // 主消息循环:
...
ATOM MyRegisterClass(HINSTANCE hInstance) {
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MEDIA));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MEDIA);
